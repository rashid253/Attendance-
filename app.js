...
window.addEventListener('DOMContentLoaded', () => {
  ...
  loadReg.onclick = e => {
    ...
    document.getElementById('registerSummaryBody').innerHTML='';
    ...
    students.forEach((s,i)=>{
      ...
      document.getElementById('registerBody').appendChild(tr);
    });
    ...
    students.forEach(s=>{
      ...
      document.getElementById('registerSummaryBody').appendChild(tr);
    });
  ...
  shareReg2.onclick = e=>{
    ...
    const lines=Array.from(document.querySelectorAll('#registerSummaryBody tr')).map(r=>{
      const tds=r.querySelectorAll('td');

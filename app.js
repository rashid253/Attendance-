// app.js (fully integrated with the provided HTML)
// ----------------------------------------------
...
// Load from Firebase onValue
onValue(appDataRef, async (snapshot) => {
  if (!snapshot.exists()) { await loadSetup(); return; }
...
// DOMContentLoaded: set up UI and handlers

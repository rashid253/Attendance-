// app.js (fully comprehensive version with all sections, including counters and unchanged parts)
// -------------------------------------------------------------------------------------------------
...
// ----------------------
let students       = [];    // Array of { sr, adm (string), name, parent, contact, occupation, address, cls, sec }
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  function updateCounters() {
    ...
    students.forEach(s => {
      // Only consider if in current class+section

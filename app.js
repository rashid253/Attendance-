...
<body>
  ...
  <section id="attendance-section">
    ...
    <div class="row-inline">
      ...
      <button id="shareAllAttendance" class="no-print"><i class="fas fa-share-alt"></i> Share All</button>
    </div>
  ...
  <section id="analytics-section">
    ...
    <div class="table-actions hidden" id="analyticsActions">
      <button id="generateFineReport" class="no-print"><i class="fas fa-file-pdf"></i> Fine Report</button>

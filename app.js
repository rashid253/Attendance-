...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  applyFilter.onclick = () => {
    const allChk = filterDialog.querySelector('input[name="infoFilter"][value="all"]');
    filterOptions.all = allChk.checked;
    hide(filterDialog);
  };

...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  // --- 7. STUDENT REGISTRATION (with Fine, Status, Share per Row) ---
  function renderStudents() {
    ...
    students.forEach((s,i) => {
      ...
      tr.innerHTML = `
        ...
        <td>
          <button class="add-payment-btn" data-adm="${s.adm}">
            <i class="fas fa-coins"></i>
          </button>
        </td>
        <td>
          <i class="fas fa-share-alt share-row" data-adm="${s.adm}"></i>
        </td>
      `;
  ...
  // ... [rest of registration edit/delete/save logic unchanged] ...

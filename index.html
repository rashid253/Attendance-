...
<head>
  ...
  <script type="module" src="https://www.gstatic.com/firebasejs/9.22.2/firebase-analytics.js"></script>
  <!-- Add any other Firebase SDKs you need -->
</head>
<body>
  <div id="appRoot">
    <!-- ==================================
      ...
      <form id="signupForm">
        ...
        <div class="step hidden" id="signupStep4">
          ...
          <div id="sectionsContainer">
            <!-- JS populates one block per class -->
          </div>
